...
> **חדש בפרויקט?** התחל מ-[`ONBOARDING.md`](./ONBOARDING.md) - מה המערכת
> עושה, איך מריצים, למה מתחברים, ואיפה מחפשים כשמשהו לא עובד. הקובץ
> הנוכחי הוא סקירה קצרה, לא נקודת כניסה.
